...
import { shareLink as dbShareLink } from '../../shareLink'

/**
 * Cria vinculo entre supervisor e usuário
 */
export async function linkSupervisorToUser(request: Request, response: Response, next: NextFunction) {
    try {
        ...
        dbUser.sendNotificationToUserId(userId, 'Vinculo com supervisor', 'Você foi vinculado a um supervisor')
